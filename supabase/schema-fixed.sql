-- Olumba Database Schema for Supabase (Fixed Version)
-- Run this in your Supabase SQL Editor

-- NOTE: We don't enable RLS on auth.users as it's a system table
-- ALTER TABLE auth.users ENABLE ROW LEVEL SECURITY; -- REMOVED
