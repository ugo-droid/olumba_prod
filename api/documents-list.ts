// =============================
// DOCUMENTS LIST API Endpoint - SIMPLIFIED (NO AUTH)
// =============================

export default async function handler(req: any, res: any) {
  // Log everything at the start
  console.log('=== API DOCUMENTS LIST START ===');
  ...
  try {
    ...
    const response = {
      success: true,
      message: 'DOCUMENTS LIST received (basic implementation)',
      data: {
        id: `documents-list_${Date.now()}`,
        ...data,
    ...
    console.log('=== API DOCUMENTS LIST END SUCCESS ===');
