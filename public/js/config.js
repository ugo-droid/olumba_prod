...
// Clerk Redirect URLs
window.CLERK_SIGN_IN_REDIRECT_URL = '/dashboard.html';
window.CLERK_SIGN_UP_REDIRECT_URL = '/onboarding.html';
window.CLERK_AFTER_SIGN_IN_URL = '/dashboard.html';
window.CLERK_AFTER_SIGN_UP_URL = '/onboarding.html';
